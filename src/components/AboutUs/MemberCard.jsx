...
const MemberCard = ({
  ...
  return (
    <div className="member-card bg-zinc-100 flex flex-col items-center justify-around px-4 pb-4 hover:shadow-3xl  hover:-translate-y-2 transition-all duration-300 ease-in-out rounded-lg">
